/**
 * Comprehensive E2E tests for TradingView CLI operations.
...
describe('TradingView CLI — Full E2E', () => {
  ...
  describe('Health & Connection', () => {
    ...
    it('tv status — CDP connection + chart state', async () => {
    ...
    it('discovers available API paths', async () => {
    ...
    it('inspects panels, buttons, and chart state', async () => {
      const state = await evaluate(`
        (function() {
          var ui = {};
